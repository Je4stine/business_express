...
import Logo from '../UI/images/Logo1.png';
...
const Header = () => {
  ...
  return (
    <div>
      ...
      {/* Navbar */}
      <nav style={{ borderBottom: "0.5px solid #4169e1", backgroundColor:"#4169e1" }} className="navbar navbar-expand-lg navbar-light">
        {/* Container wrapper */}
        <div className="container-fluid">
          {/* Navbar brand */}
          <Link to="/" className="navbar-brand">
            <img className="logo" src={Logo} alt="Business Express" />
            <h1 style={{fontWeight:'bold', color:'yellow'}}>Business Express</h1>
          </Link>
          {/* Toggle button */}
